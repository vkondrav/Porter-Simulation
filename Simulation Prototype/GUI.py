...
"}"))
        ...
        self.splitter_3.setGeometry(QtCore.QRect(40, 140, 261, 20))
        ...
        self.splitter_2.setGeometry(QtCore.QRect(40, 80, 261, 21))
        ...
        self.simDuration.setMaximum(5.0)
        self.simDuration.setObjectName(_fromUtf8("simDuration"))
        self.label_15 = QtGui.QLabel(self.splitter_2)
...
"}"))
        ...
        self.numberOfPorters = QtGui.QSpinBox(self.tab_3)
        self.numberOfPorters.setEnabled(False)
        self.numberOfPorters.setGeometry(QtCore.QRect(150, 20, 52, 20))
        ...
        self.label_16.setGeometry(QtCore.QRect(50, 20, 99, 20))
        self.label_16.setObjectName(_fromUtf8("label_16"))
        self.label_17 = QtGui.QLabel(self.tab_3)
        self.label_17.setGeometry(QtCore.QRect(50, 50, 87, 16))
        self.label_17.setObjectName(_fromUtf8("label_17"))
        self.jobDistribution = QtGui.QComboBox(self.tab_3)
        self.jobDistribution.setEnabled(False)
        self.jobDistribution.setGeometry(QtCore.QRect(160, 50, 155, 20))
        ...
        self.label_61.setGeometry(QtCore.QRect(50, 90, 215, 28))
        self.label_61.setObjectName(_fromUtf8("label_61"))
        self.correctEquipment = QtGui.QDoubleSpinBox(self.tab_3)
        self.correctEquipment.setEnabled(False)
        self.correctEquipment.setGeometry(QtCore.QRect(200, 90, 93, 28))
        ...
        self.label_10.setGeometry(QtCore.QRect(70, 130, 101, 16))
        self.label_10.setObjectName(_fromUtf8("label_10"))
        self.patientReadiness = QtGui.QDoubleSpinBox(self.tab_3)
        self.patientReadiness.setEnabled(False)
        self.patientReadiness.setGeometry(QtCore.QRect(190, 130, 81, 16))
        ...
        self.label_62.setGeometry(QtCore.QRect(50, 180, 147, 16))
        self.label_62.setObjectName(_fromUtf8("label_62"))
        self.jobCancel = QtGui.QDoubleSpinBox(self.tab_3)
        self.jobCancel.setEnabled(False)
        self.jobCancel.setGeometry(QtCore.QRect(210, 180, 63, 16))
        ...
        self.label_5.setGeometry(QtCore.QRect(120, 230, 87, 16))
        self.label_5.setObjectName(_fromUtf8("label_5"))
        self.startDate = QtGui.QDateEdit(self.tab_3)
        self.startDate.setEnabled(False)
        self.startDate.setGeometry(QtCore.QRect(240, 230, 90, 20))
        ...
        self.label_7.setGeometry(QtCore.QRect(350, 230, 16, 16))
        self.label_7.setObjectName(_fromUtf8("label_7"))
        self.endDate = QtGui.QDateEdit(self.tab_3)
        self.endDate.setEnabled(False)
        self.endDate.setGeometry(QtCore.QRect(380, 230, 90, 20))
        ...
        self.notUsed.addTab(self.tab_3, _fromUtf8(""))
...
""))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_16.setText(_translate("Dialog", "Number of Porters", None))
        self.label_17.setText(_translate("Dialog", "Job Distribution", None))
        ...
        self.label_61.setText(_translate("Dialog", "Correct Equipment Usage", None))
        self.label_10.setText(_translate("Dialog", "Patient Readiness", None))
        self.label_62.setText(_translate("Dialog", "Chance of Job Cancellation", None))
        self.label_5.setText(_translate("Dialog", "Use Data from:", None))
        ...
        self.label_7.setText(_translate("Dialog", "to:", None))
        ...
        self.notUsed.setTabText(self.notUsed.indexOf(self.tab_3), _translate("Dialog", "N/A", None))
