...
\begin{enumerate}
	...
	\item Double click to run Porter Simulation-1.0-win32.msi.
...
\begin{enumerate}[(i)]
	\item Windows XP/Vista/7/8 to run the simulation.
	\item Excel 2010/2013 to generate the dashboard.
\end{enumerate}
...
\section{Source code and other documentation}
The Source code for the simulation and all other documentation can be found at \textbf{https://github.com/vkondrav/Porter-Simulation}
