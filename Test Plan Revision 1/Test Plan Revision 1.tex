...
\pagestyle{fancy}
\fancyhead[L]{}
\fancyhead[c]{Test Plan Revision 1}
\fancyhead[R]{\today}											
\fancyfoot[L]{}											 
\fancyfoot[C]{}											
...
\HRule \\[0.4cm]
{ \huge \bfseries Test Plan Revision 1}\\[0.4cm] % Title of your document
\HRule \\[1.5cm]
...
\begin{center}
    ...
    Revision \# & Author & Date & Comment \\ \hline
  	...
  	6 & \shortstack{\\Nathan Johrendt} & March 17 & Test Plan Update \\ \hline
  	7 & \shortstack{\\Vitaliy Kondratiev} & April 12 & Test Plan Update \\
    \hline
    \end{tabular}
\end{center}
